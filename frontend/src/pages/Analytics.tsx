...
import { ChartBarIcon, PlusIcon, MagnifyingGlassIcon, FunnelIcon } from '@heroicons/react/24/outline';
    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Analisis mendalam tentang performa platform. Grafik, statistik, dan laporan yang informatif.
            </p>
          </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-12 text-center">
        ...
        <p className="text-gray-600 mb-8 max-w-md mx-auto">
          Halaman analytics dengan grafik interaktif dan laporan detail akan segera tersedia. Fitur ini akan memberikan insight mendalam tentang performa platform.
        </p>
